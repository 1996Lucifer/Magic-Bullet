...
class _DashboardState extends State<Dashboard> {
  ...
  Widget build(BuildContext context) {
    print("===>>>" + _listOfPreviousNews.toString());
              ...
              slivers: <Widget>[
                    ...
                    (context, index) => Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            padding:
                                EdgeInsets.only(top: preferredHeight * 0.05),
                          ),
                          Divider(
                            color: redColor,
                            height: 5,
                          ...
                          Padding(
                            padding:
                                EdgeInsets.only(top: preferredHeight * 0.01),
                          ),
                          Text(
                ...
                SliverGrid(
                  ...
                  delegate: SliverChildBuilderDelegate(
                    ...
                    childCount: _listOfNews == null ? 0 : _listOfNews.length,
                  ),
                ),
                SliverToBoxAdapter(
                            ...
                            GestureDetector(
                                ...
                                child: Padding(
                                    ...
                                    child: Text(
                                        (index + 1).toString() +
                                            ". " +
                                            _listOfPreviousNews[index]["heading"]
                                                .toString() +
                                            " - " +
